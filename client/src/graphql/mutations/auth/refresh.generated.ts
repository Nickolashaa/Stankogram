...
export function useRefreshMutation(
  options:
    | VueApolloComposable.UseMutationOptions<RefreshMutation, RefreshMutationVariables>
    | ReactiveFunction<
        VueApolloComposable.UseMutationOptions<RefreshMutation, RefreshMutationVariables>
      > = {},
) {
  return VueApolloComposable.useMutation<RefreshMutation, RefreshMutationVariables>(
    RefreshDocument,
    options,
  )
}
export type RefreshMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<
  RefreshMutation,

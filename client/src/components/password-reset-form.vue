...
<template>
  <Button v-if="!showForm" variant="ghost" icon="help" :short-mode="false" @click="openForm">
    Забыли пароль?
  </Button>
  ...
  <form v-else class="flex animate-appear flex-col gap-3" @submit.prevent="handleSubmit">
    ...
    <div class="flex gap-2">
      ...
      <Button type="submit" class="flex-[2]" icon="send" :short-mode="false" :disabled="loading">
        Отправить
      </Button>
    </div>
  </form>
